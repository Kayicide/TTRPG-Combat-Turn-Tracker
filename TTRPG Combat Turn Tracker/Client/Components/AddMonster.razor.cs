...
{
    public partial class AddMonster : ComponentBase
    {
        ...
        public void Add()
        {
            CharacterService.AddCharacter(new Character(_name, CharacterType.Enemy, _health) { ArmourClass = _armourClass, Initiative = _initiative});
            Close();
        }
        public void Close()
        {
